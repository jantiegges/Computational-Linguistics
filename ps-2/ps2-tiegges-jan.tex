...
\begin{AnswerBox}%% Do not delete %%%%%%%
  ...
  %%%%%%%%%%%%%%%%%%%%%%%
  The first function \textit{take-square} is missing the argument \textit{x}. The second function \textit{sum-of-squares} is missing the argument \textit{x} and \textit{y}, as it calling the function \textit{take-square} with the arguments \textit{x} and \textit{y} in the input brackets, resulting in an error. 
